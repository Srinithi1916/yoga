    ...
    <footer className="px-4 pb-8 pt-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="glass-card relative overflow-hidden rounded-[2rem] px-6 py-8 shadow-bloom sm:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.9fr_1fr_auto] lg:items-center">
            <div className="space-y-3">
              ...
              <p className="max-w-md text-sm leading-7 text-rose-900/75">
                Personalized yoga, nutrition guidance, and gentle support designed for body,
            ...
            <div className="space-y-3 text-sm text-rose-900/80">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                <span className="pill-chip">Instagram</span>
                <span className="pill-chip">YouTube</span>
                <a href={contactDetails.whatsappLink} className="pill-chip" target="_blank" rel="noreferrer">
                  WhatsApp
                </a>
              </div>
            </div>
